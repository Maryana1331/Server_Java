...
public interface ValidationConstants {
    ...
    String PARAM_PER_PAGE_NOT_NULL = "Required parameter 'perPage' is not present.";

    String PARAM_PAGE_NOT_NULL = "Required parameter 'page' is not present.";
    ...
    String NEWS_DESCRIPTION_NOT_NULL = "news description not null";
